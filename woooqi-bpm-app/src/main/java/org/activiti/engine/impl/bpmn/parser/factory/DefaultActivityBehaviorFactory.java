...
public class DefaultActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory {
  ...
  public SignTaskActivityBehavior createSignTaskActivityBehavior(SignTask signTask, TaskDefinition taskDefinition) {
    return new SignTaskActivityBehavior(signTask.getId(), taskDefinition);
  }
