...
import org.activiti.engine.impl.bpmn.parser.handler.SignTaskParseHandler;
...
import org.activiti.engine.impl.history.parse.SignTaskHistoryParseHandler;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {  
  ...
  */
  ...
  protected List<BpmnParseHandler> getDefaultBpmnParseHandlers() {
    ...
    bpmnParserHandlers.add(new SignTaskParseHandler());
  ...
  protected List<BpmnParseHandler> getDefaultHistoryParseHandlers() {
    ...
    parseHandlers.add(new SignTaskHistoryParseHandler());
