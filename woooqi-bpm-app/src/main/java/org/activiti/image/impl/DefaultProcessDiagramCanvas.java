...
public class DefaultProcessDiagramCanvas {
  ...
  protected static Color BACK_COLOR = Color.RED;
  protected static Color JUMP_COLOR = Color.GREEN;
  protected static Color ACTIVE_COLOR = Color.ORANGE;
  ...
  protected static BufferedImage SIGNTASK_IMAGE;
  ...
  public void initialize(String imageType) {
    ...
    try {
      ...
      SIGNTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("org/activiti/icons/businessRuleTask.png", customClassLoader));
  ...
  public void drawTransitionSequenceflow(int[] xPoints, int[] yPoints, String type) {
		    
	    Paint originalPaint = g.getPaint();
	    Stroke originalStroke = g.getStroke();

	    if(type.equals("jump")){
	    	g.setPaint(JUMP_COLOR);
	    }else if(type.equals("back")){
	    	g.setPaint(BACK_COLOR);
  		}
  ...
  public void drawSignTask(String name, GraphicInfo graphicInfo, double scaleFactor) {
    drawTask(SIGNTASK_IMAGE, name, graphicInfo, scaleFactor);
  }
  ...
  public void drawActiveHighLight(int x, int y, int width, int height) {
	    Paint originalPaint = g.getPaint();
	    Stroke originalStroke = g.getStroke();
  ...
  public void drawGatewayHighLight(int x, int y, int width, int height) {
	    Paint originalPaint = g.getPaint();
	    Stroke originalStroke = g.getStroke();
