...
var SIGNTASK_IMAGE = 		"images/deployer/business_rule.png";
...
// TODO: generate polylineId or do something!!
	...
	*/
	...
	drawSignTask: function(name, x, y, width, height) {
		  this.g.setStart();
			this._drawTask(name, x, y, width, height);
			var img = this.g.image(SIGNTASK_IMAGE, x + ICON_PADDING, y + ICON_PADDING, ICON_SIZE, ICON_SIZE);
			var set = this.g.setFinish();
			this.addHandlers(set, x, y, width, height, "task");
		},
