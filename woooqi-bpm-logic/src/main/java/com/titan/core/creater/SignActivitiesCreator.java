package com.titan.core.creater;
...
public class SignActivitiesCreator extends RuntimeActivityCreatorSupport implements RuntimeActivityCreator {
	...
	public ActivityImpl[] createActivities(ProcessEngine processEngine, ProcessDefinitionEntity processDefinition,RuntimeActivityDefinitionEntity info) {
		info.setFactoryName(SignActivitiesCreator.class.getName());
