...
public class SplitTaskCommand implements Command<java.lang.Void> {
	
	private TaskEntity currentTaskEntity;
	private ActivityImpl activity;
	protected Map<String, Object> variables;

	public SplitTaskCommand(TaskEntity currentTaskEntity, ActivityImpl activity, Map<String, Object> variables) {
